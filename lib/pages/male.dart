                        ...
                        child: SizedBox(
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                                ...
                                hintText: "Yaşınızı Giriniz Giriniz",
                                filled: true,
                                fillColor: Colors.deepPurple.shade50),
                            validator: (value) {
                              if (value == null || value.isEmpty) {
                                return "Yaşınızı Giriniz Giriniz";
                              }
                              return null;
                            },
                          ),
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Divider(indent: 50, endIndent: 50, thickness: 3, color: Colors.black)
      ],
    );
  }
}
